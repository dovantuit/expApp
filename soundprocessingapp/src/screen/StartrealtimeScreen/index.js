...
class StartrealtimeScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      bien_moi: 0,
  ...
  // bắt giá trị của biến slider_value truyền từ page7 vào
  componentDidMount() {
          ...
          <View>
            <View style={styles.block}>
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
                {"\n"}0 SPM now vs. 220 Target SPM{"\n"}</Text>
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
                {"\n"}0 Average Speech Block Length vs. 0 Target
              </Text>
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
                {"\n"}NaN% Breathing Target
              </Text>
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
            ...
            <View style={styles.displayInlineBlock}>
              <Button
                ...
                onPress={() => NavigationService.navigate('Finishrealtime')}
              />
...
export default StartrealtimeScreen
