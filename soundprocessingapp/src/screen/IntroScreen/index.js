          ...
          <View>
            <View style={styles.block}>
              ...
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
                I'm a digital coach to help you train your voice.{"\n"}{"\n"}
                This is a demo with one of my talents.{"\n"}{"\n"}
                I can tell you if you are speaking faster than you want to practice, and i can help to tell you when you are not breathing enough while talking.{"\n"}{"\n"}
                Let's get started.
            </Text>
            </View>
            <View style={styles.displayInlineBlock}>
              <Button
                ...
                onPress={() => {
                  NavigationService.navigate('Initcal');
                  // Display.flipPage('initcal')
                }}
              />
              <Button
                label={'Help'}
