      ...
      <View style={styles.container}>
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          <View style={styles.block}>
            <Text style={{ fontSize: typography.XL_TEXT, color: colors.TEXT, textAlign: "center", fontFamily: typography.FONT_DEFALT }}>
              {"\n"}BeneTalk{"\n"}</Text>
            <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "center", fontFamily: typography.FONT_DEFALT }}>
              Welcome to BeneTalk, to get started please log in or create{"\n"} a new account.</Text>
            <Input
              label={'First Name'}
