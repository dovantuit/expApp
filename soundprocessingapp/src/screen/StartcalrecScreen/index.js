...
class StartcalrecScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
          ...
          <View>
            <View style={styles.block}>
              <Text style={{ fontSize: typography.MD_TEXT, color: colors.TEXT, textAlign: "left", fontFamily: typography.FONT_DEFALT }}>
                {"\n"}Walking down the path, I came across a brook. I could see many creatures under the water. Within the shade of ferns, there were trout. Out on a rock in the middle, was apainted turtle sunning itself. Off in the distance thunder rumbled, threatening a wet afternoon.</Text>
            </View>
            <View style={styles.displayInlineBlock}>
              <Button
                ...
                onPress={() => NavigationService.navigate('Finishcal')}
              />
              <Button
                label={'Help'}
                buttonWidth={'30%'}
...
export default StartcalrecScreen
